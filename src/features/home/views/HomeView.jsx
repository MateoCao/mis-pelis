...
function HomeView () {
  const { getMovies, setPopularMovies, setPopularSeries, setUpcomingMovies, setNewReleases, popularMovies, popularSeries, upcomingMovies, newReleases } = useMoviesContext();
  useEffect(() => {
